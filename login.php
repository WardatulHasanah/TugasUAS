...
<body>
  ...
  <div class="container-login100" style="background-image: url('page/images/laundry.png');">
    <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
      <form action="op.php" method="post" class="login100-form validate-form">
        ...
        <span class="login100-form-title p-b-37">
          <b>Laundry</b>Assyarif</a>
          <p class="login-box-msg"> Laundry Information System<br/>Copyright © 2022 SI Laundry Assyarif</p>
        </span>
