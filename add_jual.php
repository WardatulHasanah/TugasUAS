...
$dataapa = "Transaksi Laundry"; // data
                ...
                <div class="row">
                  ...
                  <div class="col-md-8"  style="margin-left:-25px">
                        ...
                        <div class="col-sm-3">
                          ...
                          <input type="text" class="form-control pull-right" id="datepicker2" name="tglnota" placeholder="Masukan Tanggal Nota" value="<?php echo $tglnota; ?>" required>
                        </div>
...
?>
           ...
           <div align="right"><?php if($tcount>=$rpp){ echo paginate_one($reload, $page, $tpages);}else{} ?></div>
                                                      ...
                                                      echo "<option value='".$row['kode']."' nama='".$row['nama']."' >".$row['nama'].", NIS: ".$row['kode']."</option>";
                                                      }
                                                      }
                                                      ?>
                                                        </select>
