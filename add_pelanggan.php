	 ...
	 <div class="container-fluid">
          ...
          <form class="form-horizontal" method="post" action="add_<?php echo $halaman; ?>" id="Myform">
			  ...
			  <div class="row">
                <div class="form-group col-md-6 col-xs-12" >
                  <label for="kode" class="col-sm-3 control-label">NIS:</label>
                  <div class="col-sm-9">
                   <?php  if($no == null || $no ==""){ ?>
                    <input type="text" class="form-control" id="kode" name="kode" placeholder="Masukkan NIS" maxlength="50" required>
                  <?php }else{ ?>
				     <input type="text" class="form-control" id="kode" name="kode" value="<?php echo $kode; ?>" maxlength="50" required>
				  <?php } ?>
				  </div>
                </div>
				</div>
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control pull-right" id="datepicker2" name="tgldaftar" placeholder="Masukan Tanggal Daftar" value="<?php echo $tgldaftar; ?>" readonly>
                  </div>
                </div>
        </div>
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  <label for="nohp" class="col-sm-3 control-label">Kamar:</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="nohp" name="nohp" value="<?php echo $nohp; ?>" placeholder="Masukan Kamar" maxlength="50" required>
                  </div>
                </div>
        </div>
				...
				<div class="row">
                  ...
                  <div class="col-sm-9">
                  <input type="text" class="form-control" id="alamat" name="alamat" value="<?php echo $alamat; ?>" placeholder="Masukan Alamat" maxlength="50" required>
                   </div>
                </div>
				</div>
